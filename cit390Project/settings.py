"""
Django settings for cit390Project project.
...
# SECRET_KEY = 'qq)w+@d%kaev7!6!(x0&#1jo0)9q7e-$1s3jh)ufvtagc$d(4*'
...
ROOT_URLCONF = 'cit390Project.urls'
...
WSGI_APPLICATION = 'cit390Project.wsgi.application'
...
#STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles/')  # Local collectstatic target
# Django automatically discovers static files inside each app's static/
